...
#Description: On this document you can find the main application
#here I present all the functions that call the html pages and that
#catch the main variables.
